...
const QuestionDiv = ({ details, handleAnswer }) => {
  return (
    <div class="flex p-2 items-center flex-col bg-gray-200 shadow-2xl rounded-3xl w-11/12 h-5/6 md:w-9/12 md:h-5/6">
      <div class="flex flex-col items-center h-full w-5/6 mt-2 p-4 bg-white rounded-3xl shadow overflow-y-auto justify-center">
        <div >
          <p class="text-base">{details.question}</p>
        </div>
      </div>
      <div class="flex flex-col w-5/6 h-5/6 bg-gray-100 mt-4 my-4 ">
